...
internal struct InternalUnkeyedEncodingContainer: UnkeyedEncodingContainer {
    ...
    func encodeNil() throws {
        enclosingContainer.addToUnkeyedContainer(value: AWSDynamoDB.DynamoDbClientTypes.AttributeValue.null(true)) }
    
    func encode(_ value: Bool) throws {
        enclosingContainer.addToUnkeyedContainer(value: AWSDynamoDB.DynamoDbClientTypes.AttributeValue.bool(value)) }
    
    func encode(_ value: Int) throws {
        enclosingContainer.addToUnkeyedContainer(value: AWSDynamoDB.DynamoDbClientTypes.AttributeValue.n(String(value)))
    }
    ...
    func encode(_ value: String) throws {
        enclosingContainer.addToUnkeyedContainer(value: AWSDynamoDB.DynamoDbClientTypes.AttributeValue.s(value))
    }
