...
internal class InternalSingleValueEncodingContainer: SingleValueEncodingContainer {
    ...
    func encodeNil() throws {
        containerValue = .singleValue(AWSDynamoDB.DynamoDbClientTypes.AttributeValue.null(true))
    }
    
    func encode(_ value: Bool) throws {
        containerValue = .singleValue(AWSDynamoDB.DynamoDbClientTypes.AttributeValue.bool(value))
    }
    
    func encode(_ value: Int) throws {
        containerValue = .singleValue(AWSDynamoDB.DynamoDbClientTypes.AttributeValue.n(String(value)))
    }
    ...
    func encode(_ value: String) throws {
        containerValue = .singleValue(AWSDynamoDB.DynamoDbClientTypes.AttributeValue.s(value))
    }
    ...
    func encode<T>(_ value: T) throws where T: Encodable {
        if let date = value as? Foundation.Date {
            ...
            containerValue = .singleValue(AWSDynamoDB.DynamoDbClientTypes.AttributeValue.s(dateAsString))
            return
        }
...
extension InternalSingleValueEncodingContainer: AttributeValueConvertable {
    var attributeValue: AWSDynamoDB.DynamoDbClientTypes.AttributeValue {
        ...
        case .unkeyedContainer(let values):
            ...
            return AWSDynamoDB.DynamoDbClientTypes.AttributeValue.l(mappedValues)
        case .keyedContainer(let values):
            let mappedValues = values.mapValues { value in value.attributeValue }
        
            return AWSDynamoDB.DynamoDbClientTypes.AttributeValue.m(mappedValues)
        }
    }
}
