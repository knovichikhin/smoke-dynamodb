...
public enum SmokeDynamoDBError: Error {
    ...
    case dynamoDBGetError(cause: GetItemOutputError)
    case dynamoDBQueryError(cause: QueryOutputError)
    case dynamoDBExecuteStatementError(cause: ExecuteStatementOutputError)
