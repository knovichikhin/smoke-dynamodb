...
internal struct InternalKeyedEncodingContainer<K: CodingKey>: KeyedEncodingContainerProtocol {
    ...
    func encodeNil(forKey key: Key) throws {
        enclosingContainer.addToKeyedContainer(key: key, value: AWSDynamoDB.DynamoDbClientTypes.AttributeValue.null(true))
    }
    
    func encode(_ value: Bool, forKey key: Key) throws {
        enclosingContainer.addToKeyedContainer(key: key, value: AWSDynamoDB.DynamoDbClientTypes.AttributeValue.bool(value))
    }
    
    func encode(_ value: Int, forKey key: Key) throws {
        enclosingContainer.addToKeyedContainer(key: key, value: AWSDynamoDB.DynamoDbClientTypes.AttributeValue.n(String(value)))
    }
    ...
    func encode(_ value: String, forKey key: Key) throws {
        enclosingContainer.addToKeyedContainer(key: key, value: AWSDynamoDB.DynamoDbClientTypes.AttributeValue.s(value)) }
